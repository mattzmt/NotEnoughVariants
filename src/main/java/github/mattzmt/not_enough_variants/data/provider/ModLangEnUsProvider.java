...
public class ModLangEnUsProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_DOOR, "Chiseled Stone Brick Door");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_WALL, "Chiseled Stone Brick Wall");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_FENCE, "Chiseled Stone Brick Fence");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_FENCE_GATE, "Chiseled Stone Brick Fence Gate");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_STAIRS, "Chiseled Stone Brick Stairs");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_SLAB, "Chiseled Stone Brick Slab");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_TRAPDOOR, "Chiseled Stone Brick Trapdoor");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_PRESSURE_PLATE, "Chiseled Stone Brick Pressure Plate");
        translationBuilder.add(ModBlocks.CHISELED_STONE_BRICK_BUTTON, "Chiseled Stone Brick Button");
